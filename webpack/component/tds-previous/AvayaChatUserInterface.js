...
import { closeModal, initializeModals, openModal } from '../../tds/tds-previous/tds.js';
...
class AvayaChatUserInterface {
  ...
  init() {
    ...
    initializeModals({ onCloseFinish: () => {}, onCloseStart: () => {} });
  ...
  createButtonElements(containerName, elements) {
    ...
    Object.entries(elements).forEach(([key, value]) => {
      if (key === 'account-support') {
        ...
        const localizedSupportURL = localizeUrl('/contactus', { locale });
